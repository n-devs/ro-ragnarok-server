...
(function build() {
    ...
    const modules = {
        ...
        'H': { path: '/index.html', action: () => copyFolder('./index.html', `${basePath}/index.html`) },
        'A': { path: '/AI', action: () => copyFolder('./AI', `${basePath}/AI`) },
        'B': { path: '/BGM', action: () => copyFolder('./BGM', `${basePath}/BGM`) },
        'ESC': { path: '/EasyAntiCheat', action: () => copyFolder('./EasyAntiCheat', `${basePath}/EasyAntiCheat`) },
        'ND': { path: '/Navigationdata', action: () => copyFolder('./Navigationdata', `${basePath}/Navigationdata`) },
        'SKIN': { path: '/skin', action: () => copyFolder('./skin', `${basePath}/skin`) },
        'SYSTEM': { path: '/System', action: () => copyFolder('./System', `${basePath}/System`) },
        'I': { path: '/images', action: () => copyFolder('./images', `${basePath}/images`) },
        'F': { path: '/manifest.json', action: () => copyFolder('./manifest.json', `${basePath}/manifest.json`) },
        'W': { path: '/service-worker.js', action: () => copyFolder('./service-worker.js', `${basePath}/service-worker.js`) },
        'V': { path: '/middleware.js', action: () => copyFolder('./middleware.js', `${basePath}/middleware.js`) }
    };
